...
class DataValidation:
    ...
    def validate_number_of_columns(self, dataframe: pd.DataFrame) -> bool:
        """Check if DataFrame has same number of columns as schema"""
        try:
    ...
    def detect_dataset_drift(self,
        ...
        """Use KS test to detect data drift between two DataFrames"""
        try:
            status = True
            report = {}
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        """Run all validation steps and return artifact"""
        try:
            # Get train/test file paths from data ingestion artifact
            ...
            # Save valid data to validated folder
