...
class TrainingPipeline:
    ...
    def sync_artifact_dir_to_s3(self):
        """Push entire Artifacts/timestamp/ folder to S3"""
        try:
            ...
            logging.info(f"Artifact synced to S3: {aws_bucket_url}")
        except Exception as e:
            raise NetworkSecurityException(e, sys)

    def sync_saved_model_dir_to_s3(self):
        """Push final_model/ to S3 with timestamp versioning"""
        try:
            ...
            logging.info(f"Final model synced to S3: {aws_bucket_url}")
        except Exception as e:
            raise NetworkSecurityException(e, sys)
    ...
    def run_pipeline(self) -> ModelTrainerArtifact:
        try:
            ...
            # Push artifacts and model to S3
